...
export default function Footer() {
  return (
    <div className="bg-neutral-500 w-full h-full rounded-3xl p-4 flex flex-col md:flex-row space-y-4">
      ...
      <div className="w-full md:w-2/3 flex items-start justify-center flex-col space-y-3 pr-4 md:px-0">
        <div className="flex space-x-2 justify-center">
          <div className="w-8 md:w-16 h-6 flex  ">
            <svg
          ...
          <div className="break-all">quirozrmartin@gmail.com</div>
        </div>
        <div className="flex space-x-2">
          ...
          <div className="break-all">
            https://github.com/MartinQR/courseProject_front
          </div>
        </div>
      </div>
    </div>
